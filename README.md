...
- **Skill Check System (RPG)**: Механика проверки навыков (d20 + модификаторы) в диалогах, влияющая на успех расследования.
...
- **E2E Typings**: Сквозная типизация API между сервером и клиентом через Eden Treaty.
