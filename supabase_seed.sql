...
('loc_student_house', 'fbg1905', 'Corps Suevia House', 'Fraternity house. Making noise even at this hour.', 47.99, 7.848, 'INTEREST', '/images/detective/loc_student_house.png', NULL, '[{"id":"corps_visit","trigger":"marker_click","label":"Question Students","priority":10,"actions":[{"type":"start_vn","scenarioId":"detective_case1_corps_interview"}]}]', NULL, 1),
('loc_pub_deutsche', 'fbg1905', 'Zum Deutschen Haus', 'A labyrinthine inn popular with locals and travelers.', 47.992, 7.854, 'NPC', '/images/detective/loc_ganter_brauerei.png', NULL, '[{"id":"pub_gossip","trigger":"marker_click","label":"Listen for Rumors","priority":10,"actions":[{"type":"start_vn","scenarioId":"detective_case1_pub_gossip"}]}]', NULL, 1),
...
('loc_tailor', 'fbg1905', 'Schneider''s Workshop', 'Leopold Fein''s tailoring shop. Specializes in theatrical costumes and disguises.', 47.9935, 7.8525, 'NPC', '/images/detective/loc_tailor.png', NULL, '[{"id":"tailor_enter","trigger":"marker_click","label":"Enter Workshop","priority":10,"actions":[{"type":"start_vn","scenarioId":"lead_tailor"}]},{"id":"tailor_trade","trigger":"marker_click","label":"Order Tailoring","priority":9,"actions":[{"type":"open_trade","shopId":"tailor_shop"}]}]', '{"voices":{"perception":"Fabric samples everywhere. A man who notices details."}}', 1),
('loc_apothecary', 'fbg1905', 'Loewen-Apotheke', 'Adalbert Weiss''s pharmacy near the Munster. Remedies for any ailment... and other things.', 47.9952, 7.8535, 'NPC', '/images/detective/loc_apothecary.png', NULL, '[{"id":"apothecary_enter","trigger":"marker_click","label":"Enter Apotheke","priority":10,"actions":[{"type":"start_vn","scenarioId":"lead_apothecary"}]},{"id":"apothecary_trade","trigger":"marker_click","label":"Buy Remedies","priority":9,"actions":[{"type":"open_trade","shopId":"apothecary_shop"}]}]', '{"voices":{"senses":"The scent of herbs and chemicals. A careful inventory."}}', 1),
...
('loc_street_event', 'fbg1905', 'Street Encounter', 'A commotion on the street.', 47.9945, 7.8505, 'INTEREST', '/images/detective/loc_streets.png', NULL, '[{"id":"trigger_interlude_a","trigger":"marker_click","label":"Investigate Commotion","priority":100,"actions":[{"type":"start_vn","scenarioId":"interlude_victoria_street"}]}]', NULL, 1),
...
('CASE01_BRIEFING_01', '[{"type":"start_vn","scenarioId":"detective_case1_briefing"},{"type":"unlock_point","pointId":"loc_hbf"},{"type":"add_flags","flags":["case01_started"]}]', true, 'Initial briefing for Case 01'),
...
('CASE01_PUB_03', '[{"type":"start_vn","scenarioId":"detective_case1_pub_rumors"},{"type":"unlock_point","pointId":"loc_pub_deutsche"}]', true, 'Pub rumors event'),
